...
define void @execute(ptr %0, ptr %1, ptr %2) local_unnamed_addr #1 {
  ...
  %12 = tail call ptr @"0x56063b3c6250"(ptr %1, ptr nonnull inttoptr (i64 139659049015448 to ptr), ptr %2)
...
17:                                               ; preds = %95
  ...
  %19 = tail call i32 @"0x56063b3d4c30"(i32 0, ptr %18, ptr nonnull inttoptr (i64 139659049015456 to ptr))
  %20 = tail call ptr @"0x56063b3c9750"(i32 1, ptr %18, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %21 = tail call ptr @"0x56063b3c9750"(i32 2, ptr %18, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %22 = tail call ptr @"0x56063b3c9750"(i32 3, ptr %18, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %23 = tail call ptr @"0x56063b3c9750"(i32 4, ptr %18, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %24 = tail call ptr @"0x56063b3c9750"(i32 5, ptr %18, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %25 = tail call i64 @"0x56063b3d6590"(i32 6, ptr %18, ptr nonnull inttoptr (i64 139659049015456 to ptr))
  %26 = tail call ptr @"0x56063b3c9750"(i32 7, ptr %18, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %27 = load ptr, ptr %26, align 8
  %28 = getelementptr i8, ptr %26, i64 16
  %29 = load i64, ptr %28, align 4
  tail call void @"0x56063b3c35c0"(ptr %18)
  %30 = tail call ptr @"0x56063b3dd7d0"(ptr %96)
  tail call void @"0x56063b3e7050"(ptr %96, ptr %5, ptr %27, i64 %29, ptr %30)
  br label %31
...
35:                                               ; preds = %88, %._crit_edge, %31
  ...
  tail call void @"0x56063b3dd750"(ptr %36, i64 %37)
  tail call void @"0x56063b3ddbf0"(ptr %36, i64 %6)
  tail call void @"0x56063b3dd8c0"(ptr %36, i64 %7)
  tail call void @"0x56063b3dd930"(ptr %36, i64 %9)
  tail call void @"0x56063b3ddcd0"(ptr %36, i64 %8)
  %38 = tail call ptr @"0x56063b154210"(ptr %0, i64 1)
  tail call void @"0x56063b141930"(ptr %38, i1 true, i64 %10, i1 %11, ptr %36)
  tail call void @"0x56063b153e20"(ptr %0, ptr %36)
  br label %16
...
.lr.ph:                                           ; preds = %39, %61
  ...
  %44 = tail call ptr @"0x56063b3dd7d0"(ptr %1)
  %45 = tail call i32 @"0x56063b3d4c30"(i32 0, ptr nonnull %40, ptr nonnull inttoptr (i64 139659049015456 to ptr))
  %46 = tail call ptr @"0x56063b3c9750"(i32 1, ptr nonnull %40, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %47 = tail call ptr @"0x56063b3c9750"(i32 2, ptr nonnull %40, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %48 = tail call ptr @"0x56063b3c9750"(i32 3, ptr nonnull %40, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %49 = tail call ptr @"0x56063b3c9750"(i32 4, ptr nonnull %40, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %50 = tail call ptr @"0x56063b3c9750"(i32 5, ptr nonnull %40, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %51 = tail call i64 @"0x56063b3d6590"(i32 6, ptr nonnull %40, ptr nonnull inttoptr (i64 139659049015456 to ptr))
  %52 = tail call ptr @"0x56063b3c9750"(i32 7, ptr nonnull %40, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %53 = load ptr, ptr %52, align 8
  %54 = getelementptr i8, ptr %52, i64 16
  %55 = load i64, ptr %54, align 4
  tail call void @"0x56063b3c35c0"(ptr nonnull %40)
  %56 = icmp ugt i64 %42, 16383
  br i1 %56, label %57, label %61

57:                                               ; preds = %.lr.ph
  tail call void @"0x56063b3dd750"(ptr %43, i64 %42)
  tail call void @"0x56063b3ddbf0"(ptr %43, i64 %6)
  tail call void @"0x56063b3dd8c0"(ptr %43, i64 %7)
  tail call void @"0x56063b3dd930"(ptr %43, i64 %9)
  tail call void @"0x56063b3ddcd0"(ptr %43, i64 %8)
  %58 = tail call ptr @"0x56063b154210"(ptr %0, i64 1)
  tail call void @"0x56063b141930"(ptr %58, i1 false, i64 %10, i1 %11, ptr %43)
  tail call void @"0x56063b153e20"(ptr %0, ptr %43)
  %59 = tail call ptr @"0x56063b154290"(ptr %0)
  %60 = tail call ptr @"0x56063b3dd7d0"(ptr %59)
  br label %61

61:                                               ; preds = %57, %.lr.ph
  %62 = phi ptr [ %59, %57 ], [ %43, %.lr.ph ]
  %63 = phi i64 [ 0, %57 ], [ %42, %.lr.ph ]
  %64 = tail call ptr @"0x56063b3dd7d0"(ptr %62)
  %65 = shl nuw nsw i64 %63, 4
  %66 = getelementptr i8, ptr %64, i64 %65
  tail call void @"0x56063b3e7050"(ptr %62, ptr %5, ptr %53, i64 %55, ptr %66)
...
._crit_edge:                                      ; preds = %61, %39
  ...
  %69 = tail call i1 @"0x56063b3c4f40"(ptr %1, ptr nonnull inttoptr (i64 139659049015448 to ptr), ptr %2)
  br i1 %69, label %70, label %35

70:                                               ; preds = %._crit_edge
  %71 = getelementptr i8, ptr %98, i64 120
  %72 = tail call i32 @"0x56063b3d4c30"(i32 0, ptr %71, ptr nonnull inttoptr (i64 139659049015456 to ptr))
  %73 = tail call ptr @"0x56063b3c9750"(i32 1, ptr %71, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %74 = tail call ptr @"0x56063b3c9750"(i32 2, ptr %71, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %75 = tail call ptr @"0x56063b3c9750"(i32 3, ptr %71, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %76 = tail call ptr @"0x56063b3c9750"(i32 4, ptr %71, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %77 = tail call ptr @"0x56063b3c9750"(i32 5, ptr %71, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %78 = tail call i64 @"0x56063b3d6590"(i32 6, ptr %71, ptr nonnull inttoptr (i64 139659049015456 to ptr))
  %79 = tail call ptr @"0x56063b3c9750"(i32 7, ptr %71, ptr nonnull inttoptr (i64 139659049015456 to ptr), ptr %2)
  %80 = load ptr, ptr %79, align 8
  %81 = getelementptr i8, ptr %79, i64 16
  %82 = load i64, ptr %81, align 4
  tail call void @"0x56063b3c35c0"(ptr %71)
...
84:                                               ; preds = %70
  ...
  %85 = tail call ptr @"0x56063b154210"(ptr %0, i64 1)
  tail call void @"0x56063b141930"(ptr %85, i1 false, i64 %10, i1 %11, ptr %.lcssa1)
  tail call void @"0x56063b153e20"(ptr %0, ptr %.lcssa1)
  %86 = tail call ptr @"0x56063b154290"(ptr %0)
  %87 = tail call ptr @"0x56063b3dd7d0"(ptr %86)
  br label %88

88:                                               ; preds = %84, %70
  %89 = phi ptr [ %86, %84 ], [ %.lcssa1, %70 ]
  %90 = phi i64 [ 0, %84 ], [ %.lcssa, %70 ]
  %91 = tail call ptr @"0x56063b3dd7d0"(ptr %89)
  %92 = shl nuw nsw i64 %90, 4
  %93 = getelementptr i8, ptr %91, i64 %92
  tail call void @"0x56063b3e7050"(ptr %89, ptr %5, ptr %80, i64 %82, ptr %93)
...
95:                                               ; preds = %3
  ...
  %98 = tail call ptr @"0x56063b3c1b40"()
