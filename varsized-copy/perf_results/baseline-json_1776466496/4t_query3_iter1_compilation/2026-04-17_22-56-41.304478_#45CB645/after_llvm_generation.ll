...
define void @execute(ptr %0, ptr %1, ptr %2) local_unnamed_addr #1 {
  ...
  %12 = tail call ptr @"0x560488a45250"(ptr %1, ptr nonnull inttoptr (i64 139730721204376 to ptr), ptr %2)
...
17:                                               ; preds = %161
  ...
  %19 = tail call i32 @"0x560488a53c30"(i32 0, ptr %18, ptr nonnull inttoptr (i64 139730721204384 to ptr))
  %20 = tail call ptr @"0x560488a48750"(i32 1, ptr %18, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %21 = load ptr, ptr %20, align 8
  %22 = getelementptr i8, ptr %20, i64 16
  %23 = load i64, ptr %22, align 4
  %24 = tail call ptr @"0x560488a48750"(i32 2, ptr %18, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %25 = load ptr, ptr %24, align 8
  %26 = getelementptr i8, ptr %24, i64 16
  %27 = load i64, ptr %26, align 4
  %28 = tail call ptr @"0x560488a48750"(i32 3, ptr %18, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %29 = load ptr, ptr %28, align 8
  %30 = getelementptr i8, ptr %28, i64 16
  %31 = load i64, ptr %30, align 4
  %32 = tail call ptr @"0x560488a48750"(i32 4, ptr %18, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %33 = load ptr, ptr %32, align 8
  %34 = getelementptr i8, ptr %32, i64 16
  %35 = load i64, ptr %34, align 4
  %36 = tail call ptr @"0x560488a48750"(i32 5, ptr %18, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %37 = load ptr, ptr %36, align 8
  %38 = getelementptr i8, ptr %36, i64 16
  %39 = load i64, ptr %38, align 4
  %40 = tail call i64 @"0x560488a55590"(i32 6, ptr %18, ptr nonnull inttoptr (i64 139730721204384 to ptr))
  %41 = tail call ptr @"0x560488a48750"(i32 7, ptr %18, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %42 = load ptr, ptr %41, align 8
  %43 = getelementptr i8, ptr %41, i64 16
  %44 = load i64, ptr %43, align 4
  tail call void @"0x560488a425c0"(ptr %18)
  %45 = tail call ptr @"0x560488a5c7d0"(ptr %162)
  store i32 %19, ptr %45, align 4
  %46 = getelementptr i8, ptr %45, i64 4
  tail call void @"0x560488a66050"(ptr %162, ptr %5, ptr %21, i64 %23, ptr %46)
  %47 = getelementptr i8, ptr %45, i64 20
  tail call void @"0x560488a66050"(ptr %162, ptr %5, ptr %25, i64 %27, ptr %47)
  %48 = getelementptr i8, ptr %45, i64 36
  tail call void @"0x560488a66050"(ptr %162, ptr %5, ptr %29, i64 %31, ptr %48)
  %49 = getelementptr i8, ptr %45, i64 52
  tail call void @"0x560488a66050"(ptr %162, ptr %5, ptr %33, i64 %35, ptr %49)
  %50 = getelementptr i8, ptr %45, i64 68
  tail call void @"0x560488a66050"(ptr %162, ptr %5, ptr %37, i64 %39, ptr %50)
  %51 = getelementptr i8, ptr %45, i64 84
  store i64 %40, ptr %51, align 4
  %52 = getelementptr i8, ptr %45, i64 92
  tail call void @"0x560488a66050"(ptr %162, ptr %5, ptr %42, i64 %44, ptr %52)
  br label %53
...
57:                                               ; preds = %147, %._crit_edge, %53
  ...
  tail call void @"0x560488a5c750"(ptr %58, i64 %59)
  tail call void @"0x560488a5cbf0"(ptr %58, i64 %6)
  tail call void @"0x560488a5c8c0"(ptr %58, i64 %7)
  tail call void @"0x560488a5c930"(ptr %58, i64 %9)
  tail call void @"0x560488a5ccd0"(ptr %58, i64 %8)
  %60 = tail call ptr @"0x5604887d3210"(ptr %0, i64 3)
  tail call void @"0x5604887c0930"(ptr %60, i1 true, i64 %10, i1 %11, ptr %58)
  tail call void @"0x5604887d2e20"(ptr %0, ptr %58)
  br label %16
...
.lr.ph:                                           ; preds = %61, %98
  ...
  %66 = tail call ptr @"0x560488a5c7d0"(ptr %1)
  %67 = tail call i32 @"0x560488a53c30"(i32 0, ptr nonnull %62, ptr nonnull inttoptr (i64 139730721204384 to ptr))
  %68 = tail call ptr @"0x560488a48750"(i32 1, ptr nonnull %62, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %69 = load ptr, ptr %68, align 8
  %70 = getelementptr i8, ptr %68, i64 16
  %71 = load i64, ptr %70, align 4
  %72 = tail call ptr @"0x560488a48750"(i32 2, ptr nonnull %62, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %73 = load ptr, ptr %72, align 8
  %74 = getelementptr i8, ptr %72, i64 16
  %75 = load i64, ptr %74, align 4
  %76 = tail call ptr @"0x560488a48750"(i32 3, ptr nonnull %62, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %77 = load ptr, ptr %76, align 8
  %78 = getelementptr i8, ptr %76, i64 16
  %79 = load i64, ptr %78, align 4
  %80 = tail call ptr @"0x560488a48750"(i32 4, ptr nonnull %62, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %81 = load ptr, ptr %80, align 8
  %82 = getelementptr i8, ptr %80, i64 16
  %83 = load i64, ptr %82, align 4
  %84 = tail call ptr @"0x560488a48750"(i32 5, ptr nonnull %62, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %85 = load ptr, ptr %84, align 8
  %86 = getelementptr i8, ptr %84, i64 16
  %87 = load i64, ptr %86, align 4
  %88 = tail call i64 @"0x560488a55590"(i32 6, ptr nonnull %62, ptr nonnull inttoptr (i64 139730721204384 to ptr))
  %89 = tail call ptr @"0x560488a48750"(i32 7, ptr nonnull %62, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %90 = load ptr, ptr %89, align 8
  %91 = getelementptr i8, ptr %89, i64 16
  %92 = load i64, ptr %91, align 4
  tail call void @"0x560488a425c0"(ptr nonnull %62)
  %93 = icmp ugt i64 %64, 2426
  br i1 %93, label %94, label %98

94:                                               ; preds = %.lr.ph
  tail call void @"0x560488a5c750"(ptr %65, i64 %64)
  tail call void @"0x560488a5cbf0"(ptr %65, i64 %6)
  tail call void @"0x560488a5c8c0"(ptr %65, i64 %7)
  tail call void @"0x560488a5c930"(ptr %65, i64 %9)
  tail call void @"0x560488a5ccd0"(ptr %65, i64 %8)
  %95 = tail call ptr @"0x5604887d3210"(ptr %0, i64 3)
  tail call void @"0x5604887c0930"(ptr %95, i1 false, i64 %10, i1 %11, ptr %65)
  tail call void @"0x5604887d2e20"(ptr %0, ptr %65)
...
98:                                               ; preds = %94, %.lr.ph
  ...
  %101 = tail call ptr @"0x560488a5c7d0"(ptr %99)
  %102 = mul nuw nsw i64 %100, 108
  %103 = getelementptr i8, ptr %101, i64 %102
  store i32 %67, ptr %103, align 4
  %104 = getelementptr i8, ptr %103, i64 4
  tail call void @"0x560488a66050"(ptr %99, ptr %5, ptr %69, i64 %71, ptr %104)
  %105 = getelementptr i8, ptr %103, i64 20
  tail call void @"0x560488a66050"(ptr %99, ptr %5, ptr %73, i64 %75, ptr %105)
  %106 = getelementptr i8, ptr %103, i64 36
  tail call void @"0x560488a66050"(ptr %99, ptr %5, ptr %77, i64 %79, ptr %106)
  %107 = getelementptr i8, ptr %103, i64 52
  tail call void @"0x560488a66050"(ptr %99, ptr %5, ptr %81, i64 %83, ptr %107)
  %108 = getelementptr i8, ptr %103, i64 68
  tail call void @"0x560488a66050"(ptr %99, ptr %5, ptr %85, i64 %87, ptr %108)
  %109 = getelementptr i8, ptr %103, i64 84
  store i64 %88, ptr %109, align 4
  %110 = getelementptr i8, ptr %103, i64 92
  tail call void @"0x560488a66050"(ptr %99, ptr %5, ptr %90, i64 %92, ptr %110)
...
._crit_edge:                                      ; preds = %98, %61
  ...
  %113 = tail call i1 @"0x560488a43f40"(ptr %1, ptr nonnull inttoptr (i64 139730721204376 to ptr), ptr %2)
  br i1 %113, label %114, label %57

114:                                              ; preds = %._crit_edge
  %115 = getelementptr i8, ptr %164, i64 120
  %116 = tail call i32 @"0x560488a53c30"(i32 0, ptr %115, ptr nonnull inttoptr (i64 139730721204384 to ptr))
  %117 = tail call ptr @"0x560488a48750"(i32 1, ptr %115, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %118 = load ptr, ptr %117, align 8
  %119 = getelementptr i8, ptr %117, i64 16
  %120 = load i64, ptr %119, align 4
  %121 = tail call ptr @"0x560488a48750"(i32 2, ptr %115, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %122 = load ptr, ptr %121, align 8
  %123 = getelementptr i8, ptr %121, i64 16
  %124 = load i64, ptr %123, align 4
  %125 = tail call ptr @"0x560488a48750"(i32 3, ptr %115, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %126 = load ptr, ptr %125, align 8
  %127 = getelementptr i8, ptr %125, i64 16
  %128 = load i64, ptr %127, align 4
  %129 = tail call ptr @"0x560488a48750"(i32 4, ptr %115, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %130 = load ptr, ptr %129, align 8
  %131 = getelementptr i8, ptr %129, i64 16
  %132 = load i64, ptr %131, align 4
  %133 = tail call ptr @"0x560488a48750"(i32 5, ptr %115, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %134 = load ptr, ptr %133, align 8
  %135 = getelementptr i8, ptr %133, i64 16
  %136 = load i64, ptr %135, align 4
  %137 = tail call i64 @"0x560488a55590"(i32 6, ptr %115, ptr nonnull inttoptr (i64 139730721204384 to ptr))
  %138 = tail call ptr @"0x560488a48750"(i32 7, ptr %115, ptr nonnull inttoptr (i64 139730721204384 to ptr), ptr %2)
  %139 = load ptr, ptr %138, align 8
  %140 = getelementptr i8, ptr %138, i64 16
  %141 = load i64, ptr %140, align 4
  tail call void @"0x560488a425c0"(ptr %115)
...
143:                                              ; preds = %114
  ...
  %144 = tail call ptr @"0x5604887d3210"(ptr %0, i64 3)
  tail call void @"0x5604887c0930"(ptr %144, i1 false, i64 %10, i1 %11, ptr %.lcssa1)
  tail call void @"0x5604887d2e20"(ptr %0, ptr %.lcssa1)
  %145 = tail call ptr @"0x5604887d3290"(ptr %0)
  %146 = tail call ptr @"0x560488a5c7d0"(ptr %145)
  br label %147

147:                                              ; preds = %143, %114
  %148 = phi ptr [ %145, %143 ], [ %.lcssa1, %114 ]
  %149 = phi i64 [ 0, %143 ], [ %.lcssa, %114 ]
  %150 = tail call ptr @"0x560488a5c7d0"(ptr %148)
  %151 = mul nuw nsw i64 %149, 108
  %152 = getelementptr i8, ptr %150, i64 %151
  store i32 %116, ptr %152, align 4
  %153 = getelementptr i8, ptr %152, i64 4
  tail call void @"0x560488a66050"(ptr %148, ptr %5, ptr %118, i64 %120, ptr %153)
  %154 = getelementptr i8, ptr %152, i64 20
  tail call void @"0x560488a66050"(ptr %148, ptr %5, ptr %122, i64 %124, ptr %154)
  %155 = getelementptr i8, ptr %152, i64 36
  tail call void @"0x560488a66050"(ptr %148, ptr %5, ptr %126, i64 %128, ptr %155)
  %156 = getelementptr i8, ptr %152, i64 52
  tail call void @"0x560488a66050"(ptr %148, ptr %5, ptr %130, i64 %132, ptr %156)
  %157 = getelementptr i8, ptr %152, i64 68
  tail call void @"0x560488a66050"(ptr %148, ptr %5, ptr %134, i64 %136, ptr %157)
  %158 = getelementptr i8, ptr %152, i64 84
  store i64 %137, ptr %158, align 4
  %159 = getelementptr i8, ptr %152, i64 92
  tail call void @"0x560488a66050"(ptr %148, ptr %5, ptr %139, i64 %141, ptr %159)
  %160 = add nuw nsw i64 %149, 1
  br label %57

161:                                              ; preds = %3
  %162 = tail call ptr @"0x5604887d3290"(ptr %0)
  %163 = tail call ptr @"0x560488a5c7d0"(ptr %162)
  %164 = tail call ptr @"0x560488a40b40"()
